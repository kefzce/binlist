...
use App\Command\BinLookupCommand;
use App\Command\ExchangeRateCommand;
use App\Command\FeeResolutionCommand;
use App\Command\TransactionCommandRunner;
...
final class TransactionChainTest extends TestCase
{
    public function testTransaction(): void
    {
        ...
        $commands = [new BinLookupCommand(new BinlistProvider($client)),
            new ExchangeRateCommand(new ExchangeRatesProvider($exchangeRateClient)),
            new FeeResolutionCommand(
                new FeeResolver([
                    new FeeRateApplier(),
                    new FixedValueFee(),
                ])
        ...
        $command = new TransactionCommandRunner($commands);
